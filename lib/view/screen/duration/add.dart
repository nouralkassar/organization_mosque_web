...
import '../../../animation/duration/add.dart';
...
class AddDuration extends StatelessWidget {
  const AddDuration({super.key});

  @override
  Widget build(BuildContext context) {
    Get.put(AddDurationControllerImp());
    ...
    return Scaffold(
      body: Stack(
        ...
        children: [
          ...
          // المحتوى (الحقول)
          GetBuilder<AddDurationControllerImp>(
