...
import '../../controller/duration/add.dart';
import '../../view/widget/auth/custombuttonauth.dart';
import '../../view/widget/auth/customtextformauth.dart';

class AnimatedAddDurationCard extends StatefulWidget {
  const AnimatedAddDurationCard({super.key});

  @override
  State<AnimatedAddDurationCard> createState() =>
      _AnimatedAddDuraionCardState();
}

class _AnimatedAddDuraionCardState extends State<AnimatedAddDurationCard> {
  ...
  Widget build(BuildContext context) {
    final controller = Get.put(AddDurationControllerImp());
                ...
                children: [
                  ...
                  Expanded(
                    child: CustomTextFormAuth(
                      ...
                      valid: (val) => validInput(val!, 3, 100, "type"),
                      isNumber: false,
                    ),
                  ),
                ],
                ...
                children: [
                  Expanded(
                    child: CustomTextFormAuth(
                      ...
                      valid: (val) => validInput(val!, 1, 13, "day"),
                      isNumber: true,
                    ),
                  ),
                ],
